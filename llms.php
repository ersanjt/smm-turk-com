...
echo "- [SMM Panel Turkey]({$base}/buy/cheap-smm-panel)\n";
echo "- [Instagram followers]({$base}/buy/instagram-followers)\n";
echo "- [TikTok views]({$base}/buy/tiktok-views)\n";
echo "- [YouTube views]({$base}/buy/youtube-views)\n";
