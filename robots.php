...
echo "Disallow: /404\n";
echo "Disallow: /deploy-webhook\n";
echo "Disallow: /repair-panel\n";
echo "Disallow: /repair-deploy\n";
echo "Disallow: /fix-app\n";
echo "Disallow: /hotfix-cprs\n";
echo "Disallow: /install-db\n";
echo "Disallow: /migrate-\n";
echo "Disallow: /seed-blog\n";
echo "Disallow: /newsletter-subscribe\n";
echo "Disallow: /og-image.php\n";
echo "Disallow: /*?*q=\n";
echo "Allow: /llms.txt\n\n";
