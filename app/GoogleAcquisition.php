        ...
        return [
            ...
            'tiktok-views' => [
                ...
                'de' => [
                    ...
                    'intro' => 'Views sind das günstigste TikTok-Wachstumssignal. Diese Seite listet View-Dienste — getrennt von der Follower-Seite. Live-Preise je 1.000, kostenlose Registrierung, nur Krypto.',
                    'body' => [
                        ['h' => 'Warum Views?', 'p' => 'Günstige Bewegung am Video. Kombiniert mit Likes und Followern wirkt das Profil ausgewogener als nur Follower.'],
                        ['h' => 'URL', 'p' => 'Nur der Video-Link. Profil-URLs funktionieren bei View-Diensten nicht.'],
                        ['h' => 'Tempo', 'p' => 'Manche Dienste liefern Tausende pro Minute, andere über 24 Stunden. Den Dienstnamen lesen.'],
                    ],
                    'how' => [
                        ['name' => 'Konto', 'text' => 'Kostenlose Registrierung.'],
                        ['name' => 'Zahlung', 'text' => 'Krypto-Guthaben.'],
                        ['name' => 'Video', 'text' => 'View-Service wählen und Video-URL einfügen.'],
                    ],
                    'faqs' => [
                        ['name' => 'Bleiben Views?', 'text' => 'Meist ja. Ticket öffnen, wenn der Zähler zurückgeht.'],
                        ['name' => 'Follower inklusive?', 'text' => 'Nein. Follower separat bestellen.'],
                        ['name' => 'Minimum?', 'text' => 'Spalte Min — bei Views oft höher.'],
                    ],
                ],
            ],
            'youtube-views' => [
                ...
                'de' => [
                    ...
                    'intro' => 'YouTube-Views können ein Video in den Vorschlägen stützen. Bei SMM Turk sind View-Dienste je 1.000 gelistet; Zahlung nur Krypto, Registrierung kostenlos.',
                    'body' => [
                        ['h' => 'Watchtime', 'p' => 'Manche Dienste zielen auf echte Wiedergabezeit, andere auf schnelle Zähler. Retention/Hour im Namen lesen. Werbeeinnahmen gehören zu YouTube — das Panel garantiert sie nicht.'],
                        ['h' => 'URL', 'p' => 'youtube.com/watch oder youtu.be. Shorts können eine eigene Zeile sein.'],
                        ['h' => 'Abos', 'p' => 'Views und Abonnenten sind getrennte Bestellungen. Für Kanalwachstum beides gestaffelt nutzen.'],
                    ],
                    'how' => [
                        ['name' => 'Registrieren', 'text' => 'Kostenloses Konto.'],
                        ['name' => 'Guthaben', 'text' => 'USDT/BTC/ETH.'],
                        ['name' => 'Video-Link', 'text' => 'View-Service wählen und Link einfügen.'],
                    ],
                    'faqs' => [
                        ['name' => 'Stehen Views in Analytics?', 'text' => 'Der YouTube-Zähler steigt; die Quelle sieht man im Panel nicht.'],
                        ['name' => 'Urheberrecht?', 'text' => 'Ihre Inhalte, Ihr Risiko. Keine Bestellung auf urheberrechtlich problematische Videos.'],
                        ['name' => 'Zahlung?', 'text' => 'Nur Krypto.'],
                    ],
                ],
            ],
            ...
            'cheap-smm-panel' => [
                ...
                'de' => [
                    ...
                    'intro' => 'Ein SMM-Panel verkauft Social-Dienste im Großhandel: Follower, Likes, Views. SMM Turk ist ein SMM Panel Türkei mit kostenloser Registrierung, Krypto-Zahlung und Preisen je 1.000 Stück. Diese Seite ist für alle, die ein günstiges Panel suchen — und für alle, die damit verdienen wollen.',
                    'body' => [
                        ['h' => 'Als Kunde nutzen', 'p' => 'Bestellen Sie für eigene Konten. Willkommensguthaben und der Bonus auf die erste Einzahlung machen den ersten Test günstig. Live-Preise stehen auch auf den Plattform-Seiten.'],
                        ['h' => 'Als Reseller verdienen', 'p' => 'Child Panel: Ihre Domain, Ihre Kunden, Ihre Marge. Affiliate: Empfehlungslink. API: Großhandel in Ihre eigene Software. Vergleichen Sie alle drei Wege auf der Earn-Seite.'],
                        ['h' => 'Warum SMM Turk?', 'p' => 'Marke mit Türkei-Fokus, Oberfläche auf TR/EN/DE, Krypto-Wallets, automatische Lieferung, Tickets. Keine Fake-Kartenlogos — die Zahlungsmethode ist klar.'],
                    ],
                    'how' => [
                        ['name' => 'Registrieren', 'text' => 'Etwa 30 Sekunden, optional mit Google Sign-In.'],
                        ['name' => 'Erstes Guthaben', 'text' => 'Krypto oder Willkommensguthaben, wenn aktiv.'],
                        ['name' => 'Bestellen oder verdienen', 'text' => 'Dienste kaufen oder auf Earn ein Reseller-Modell starten.'],
                    ],
                    'faqs' => [
                        ['name' => 'Was ist ein SMM-Panel?', 'text' => 'Ein Dashboard, das Follower, Likes und Views im Großhandel verkauft. Sie bestellen vom Guthaben; ein Anbieter liefert.'],
                        ['name' => 'SMM Panel Türkei?', 'text' => 'Ja. SMM Turk wird aus der Türkei und weltweit genutzt, mit Krypto-Checkout und TR/EN/DE Oberfläche.'],
                        ['name' => 'Ist am günstigsten am besten?', 'text' => 'Nein. Tempo, Refill und Qualität unterscheiden sich. Erst günstig testen, dann nachbestellen.'],
                        ['name' => 'Wie verdiene ich Geld?', 'text' => 'Child Panel, Affiliate und API. Details stehen auf /earn.'],
                    ],
                ],
            ],
        ];
